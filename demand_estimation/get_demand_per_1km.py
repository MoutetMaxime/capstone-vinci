...
export_dir_1km = f'{processed_dir}/1km'
os.makedirs(processed_dir, exist_ok=True)
os.makedirs(preprocessed_dir, exist_ok=True)
os.makedirs(export_dir_1km, exist_ok=True)
...
file_carroye = f'{data_dir}/Filosofi2017_carreaux_1km_met.gpkg'
...
export_file_df_adjacency_gpkg=f"{export_dir_1km}/gdf_city_with_dist.gpkg"
export_file_np_adjacency=f"{export_dir_1km}/adjacency_matrix.npy"
export_file_cs_200 = f"{export_dir_1km}/cs.gpkg"
...
cols = ['Idcar_1km', 'I_est_1km', 'Ind', 'geometry', 'Men_coll', 'Men_mais', 'Ind_snv']
gdf_carroye_city = gdf_carroye_city[cols]
gdf_carroye_city = gdf_carroye_city.rename(columns={'Idcar_1km':'id', 'I_est_1km':'estimated', 'Ind':'population', 'Ind_snv':'niveau_de_vie'}) 
...
gdf_city_1km_with_dist, adjacency_matrix = get_euclidian_adjacency_from_df(gdf_carroye_city, crs_angles=crs_angles, crs_meters=crs_meters)
...
cols += [f'dist_{i}' for i in range(len(gdf_city_1km_with_dist))]

gdf_city_with_dist = gdf_city_1km_with_dist[cols]
